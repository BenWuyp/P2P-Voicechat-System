...
const Dashboard = ({ username, onLogout, onJoin, sendMessage, lastMessage}) => {
  const {
    register,
    handleSubmit,
    watch,
  ...
  const onSubmit = (props) => {
    const jsonStr = JSON.stringify({'action':'create', 'payload': `${props.chatroomName}`})
  ...
  const handleJoinClick = (person) => {
    ...
    onJoin(person);
    const jsonStr = JSON.stringify({'action':'join', 'payload':`${person.name}`})
    sendMessage(jsonStr)
  };
  // const chatrooms = [
  //   {
  ...
  useEffect(() => {
    if (lastMessage && lastMessage.data) {
      ...
      for (const [name, props] of Object.entries(chatrooms)){
        const chatroom = {'name': name, 'number': props.members.length, 'description': `Created by ${props.createdBy}`, logo: "data:image/jpeg;base64,"}
    ...
    <div className="flex bg-gray-50">
      ...
      <Box sx={{"margin": '10px'}}>
        <form onSubmit={handleSubmit(onSubmit)}>
          <TextField placeholder='chatroom name' {...register('chatroomName', {required:true})}></TextField>
          <Button type='submit' variant='contained' sx={{"margin":"10px"}}>create chatroom</Button>
          {errors.chatroomName && <Typography sx={{"color":'red'}}>This field is required</Typography>}
        </form>
      </Box>
      {chatrooms.filter(person => person.name.toLowerCase().includes(searchTerm.toLowerCase())).map((person,index) => (
        <ul role="list" className="divide-y divide-gray-100">
            <li key={person.email} className="flex justify-between gap-x-6 py-5">
                  ...
                  <div className="flex items-center gap-x-4">
                    ...
                    <button onClick={() => {handleJoinClick(person);}} className="px-4 py-2 text-sm font-medium text-white bg-green-600 rounded hover:bg-green-700">Join</button>                  
                  </div>
            </li>
        </ul>
      ))}
